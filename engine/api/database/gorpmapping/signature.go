...
func InsertAndSign(ctx context.Context, db gorp.SqlExecutor, i gorpmapper.Canonicaller) error {
	return Mapper.InsertAndSign(ctx, db, i)
}

// UpdateAndSign a data in database, given data should implement canonicaller interface.
func UpdateAndSign(ctx context.Context, db gorp.SqlExecutor, i gorpmapper.Canonicaller) error {
...
func UpdateColumnsAndSign(ctx context.Context, db gorp.SqlExecutor, i gorpmapper.Canonicaller, colFilter gorp.ColumnFilter) error {
